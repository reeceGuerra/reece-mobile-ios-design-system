    ...
    var body: some View {
        ...
        ZStack(alignment: .topLeading) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                Text("Large Title").rdsText(.h1B, family: font.family)
                Spacer()
                Text("Title").rdsText(.h2M, family: font.family)
                Text("Title 2").rdsText(.h3M, family: font.family)
                Text("Title 3").rdsText(.h4R, family: font.family)
                Spacer()
                Text("Headline").rdsText(.h5B, family: font.family)
                Text("Subheadline").rdsText(.h5R, family: font.family)
                Spacer()
                Text("Body").rdsText(.body, family: font.family)
                Text("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.").rdsText(.body, family: font.family)
