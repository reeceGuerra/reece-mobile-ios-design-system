...
public extension ReeceColors {
    ...
    /// Access examples:
    /// ```swift
    /// let ok     = ReeceColors.support.Green.color(.t60, using: scheme)
    /// let alert  = ReeceColors.support.OrangyRed.color(.t70, using: scheme)
    /// let warn   = ReeceColors.support.Yellow.color(.t50, using: scheme)
    /// let accent = ReeceColors.support.HoverBlue.color(using: scheme) // single tone
    /// ```
...
public enum Support {
    ...
    // MARK: - Families (tones)
    public enum Green: ReecePaletteFamily {
    ...
    public enum OrangyRed: ReecePaletteFamily {
    ...
    public enum Yellow: ReecePaletteFamily {
    ...
    public enum Teal: ReecePaletteFamily {
    ...
    public enum SkyBlue: ReecePaletteFamily {
    ...
    public enum Purple: ReecePaletteFamily {
