...
final class RDSFontAssetsMapCoverageTests: XCTestCase {

    private func resolve(_ family: RDSFontFamily,
                         weight: RDSFontWeight,
                         slant: RDSFontSlant) -> RDSResolvedFont {
        ...
        return RDSFontResolver.resolve(for: spec, family: family, basePointSize: pts)
    }
    ...
    func testRoboto_NormalAndItalic_AllWeights() {
        for w in RDSFontWeight.allCases {
