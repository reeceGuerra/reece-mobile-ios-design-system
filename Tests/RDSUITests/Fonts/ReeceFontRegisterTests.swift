...
final class ReeceFontRegisterTests: XCTestCase {
    ...
    func test_fontsAreAvailableAfterRegister() {
            ...
            let newlyRegistered = ReeceFontRegister.registerAllFonts()
    ...
    func test_registerAllFonts_isIdempotentButFindsResources() {
            let first = ReeceFontRegister.registerAllFonts()
            let second = ReeceFontRegister.registerAllFonts()
